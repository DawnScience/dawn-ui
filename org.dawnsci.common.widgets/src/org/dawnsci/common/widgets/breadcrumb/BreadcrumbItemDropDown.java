...
class BreadcrumbItemDropDown {
	...
	public BreadcrumbItemDropDown(BreadcrumbItem parent, Composite composite) {
		...
		setAccessibilityText(fToolBar, BreadcrumbMessages.BreadcrumbItemDropDown_showDropDownMenu_action_toolTip);
	...
	private static void setAccessibilityText(Control control, final String text) {
