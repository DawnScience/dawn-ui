 ...
 * </p>
 * 
 * This class is a copy of PropertySheetView which ignores anything which is not a model
 * selection.
 *
 ...
 */
public class OperationModelPropertySheetView extends PageBookView implements ISelectionListener, IShowInTarget, IShowInSource, IRegistryEventListener {
    /**
     * No longer used but preserved to avoid api change
     */
    public static final String HELP_ID = "org.dawnsci.processing.ui.property_sheet_view_context";
     ...
     */
    public OperationModelPropertySheetView() {
        super();
    ...
    protected PageRec doCreatePage(IWorkbenchPart part) {
    	...
    	if(part instanceof OperationModelPropertySheetView) {
    		return null;
    	}
...
//        if (!(part.getSite().getId().equals("org.dawnsci.processing.ui.processing.ProcessingView") || part.getSite().getId().equals("org.dawnsci.processing.ui.propertySheet"))) return;
    ...
    public void selectionChanged(IWorkbenchPart part, ISelection sel) {
    	...
    	// We only respond to operation selections...
