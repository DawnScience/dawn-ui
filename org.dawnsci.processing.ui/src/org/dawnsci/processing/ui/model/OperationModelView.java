 ...
 */
public class OperationModelView extends PageBookView implements ISelectionListener, IShowInTarget, IShowInSource, IRegistryEventListener {
    /**
    ...
    protected PageRec doCreatePage(IWorkbenchPart part) {
    	...
    	if(part instanceof OperationModelView) {
    		return null;
    	}
