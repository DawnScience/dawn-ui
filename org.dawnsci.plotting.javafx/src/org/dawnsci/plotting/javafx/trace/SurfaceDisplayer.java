 ...
 */
class SurfaceDisplayer extends Scene{
     ...
     */
	public SurfaceDisplayer(Group root, MeshView isosurface, Material material, CullFace cullFace){
		...
		cam.getChildren().add(surfaceGenerator(material, cullFace));
	...
	private Group surfaceGenerator(Material material, CullFace face){
        Group group = new Group();
		
		isosurface.setMaterial(material);
		isosurface.setCullFace(face);
