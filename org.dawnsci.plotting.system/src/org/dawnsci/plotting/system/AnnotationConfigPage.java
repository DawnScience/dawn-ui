...
// NOTE this is a copy from xygraph 3.1.0 with embedded messages to work around an
// issue with its setting of font in its constructor
...
public class AnnotationConfigPage {
	...
	private static final String Annotation_ChangeFont = "Change...";
	private static final String Annotation_Color = "Color:";
	private static final String Annotation_ColorFromYAxis = "Use Y-Axis color as annotation color";
	private static final String Annotation_Cursor = "Cursor Line Style:";
	private static final String Annotation_Font = "Font:";
	private static final String Annotation_Name = "Name:";
	private static final String Annotation_NameTT = "Text that will be displayed in the annotation";
	private static final String Annotation_ShowInfo = "Show Sample Infomation";
	private static final String Annotation_ShowName = "Show Name";
	private static final String Annotation_ShowPosition = "Show Position";
	private static final String Annotation_Snap = "Snap to Trace";
	private static final String Annotation_SnapTT = "Should annotation snap to points on a trace or float freely?";
	private static final String Annotation_SystemDefault = "System Default";
	private static final String Annotation_Trace = "Trace:";
	private static final String Annotation_TraceSnapTT = "Select trace to which annotation should snap";
	private static final String Annotation_XAxis = "X-Axis:";
	private static final String Annotation_XAxisSnapTT = "Select x-axis to which annotation should snap";
	private static final String Annotation_YAxis = "Y-Axis:";
	private static final String Annotation_YAxisSnapTT = "Select value axis to which annotation should snap";
	...
	public void createPage(final Composite composite) {
		...
		yAxisLabel.setText(Annotation_YAxis);
		yAxisLabel.setLayoutData(new GridData());

		yAxisCombo = new Combo(composite, SWT.DROP_DOWN);
		yAxisCombo.setToolTipText(Annotation_YAxisSnapTT);
		...
		snapToTrace.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				if (snapToTrace.getSelection()) {
					xAxisLabel.setText(Annotation_Trace);
					xAxisOrTraceCombo.setToolTipText(Annotation_TraceSnapTT);
				} else {
					xAxisLabel.setText(Annotation_XAxis);
					xAxisOrTraceCombo.setToolTipText(Annotation_XAxisSnapTT);
				}
		...
		fontButton.setText(Annotation_ChangeFont);
		...
		fontButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (fontData != null) {
					...
					fontLabel.setText(Annotation_Font + fontData.getName());
		...
		cursorLineLabel.setText(Annotation_Cursor);
	...
	private void initialize() {
		...
		xAxisLabel.setText(snapToTrace.getSelection() ? Annotation_Trace : Annotation_XAxis);
		xAxisOrTraceCombo.removeAll();
		...
		fontLabel.setText(Annotation_Font
				+ (font == null ? Annotation_SystemDefault : font.getFontData()[0].getName()));
		fontLabel.setFont(font);
