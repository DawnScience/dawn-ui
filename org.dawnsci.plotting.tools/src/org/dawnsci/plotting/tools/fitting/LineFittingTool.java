...
public class LineFittingTool extends AbstractFittingTool {
		...
		composite.getDisplay().syncExec(new Runnable() {
		    ...
		    public void run() {
		    	try {
		    		...
		    		boolean requireRange = Activator.getPlottingPreferenceStore().getBoolean(FittingConstants.SHOW_POLY_RANGE);
		    		boolean requireTrace = Activator.getPlottingPreferenceStore().getBoolean(FittingConstants.SHOW_POLY_TRACE);
	...
	protected void createActions() {
		...
		showFitRegion.setChecked(Activator.getPlottingPreferenceStore().getBoolean(FittingConstants.SHOW_POLY_RANGE));
