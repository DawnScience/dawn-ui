			...
			public void run() {
				...
				try {
					...
					for (IRegion region : regions) {
						...
						AzimuthalProfileToolOperation op = (AzimuthalProfileToolOperation)ServiceProvider.getService(IOperationService.class).create(new AzimuthalProfileToolOperation().getId());
