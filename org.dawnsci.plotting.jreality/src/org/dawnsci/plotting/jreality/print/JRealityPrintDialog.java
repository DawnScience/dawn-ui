 ...
 */
public class JRealityPrintDialog extends Dialog {
	
	// plot view preferences
	private static final String PRINTSETTINGS_PRINTER_NAME = "printsettings.printername";
	...
	private static final Logger logger = LoggerFactory.getLogger(JRealityPrintDialog.class);
...
//		comboOrientation.addSelectionListener(orientationSelection);
	...
	private void addPropertyListeners() {
		store.addPropertyChangeListener(new IPropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
				...
				if (property.equals(PRINTSETTINGS_PRINTER_NAME)
						|| property.equals(PRINTSETTINGS_SCALE)
	...
	private int getPreferencePrintScale() {
		IPreferenceStore preferenceStore = store;
		return preferenceStore.isDefault(PRINTSETTINGS_SCALE)
				? preferenceStore.getDefaultInt(PRINTSETTINGS_SCALE)
