...
public class ImageServiceTest {
	...
	public void testPlot() {
		...
		double[] expectedResultWithLogging = {Math.log10(1.0), Math.log10(2.0), Math.log10(3.0), Math.log10(4.0)};
		...
		for (int i = 0; i < 10; i++){
			...
			Dataset resultD = imageService.getImageLoggedData(imageServiceBean1);
