...
public class CanvasNewtScaledSWT extends Composite implements IScreenCanvas {
    ...
    public CanvasNewtScaledSWT(IChartComponentFactory factory, Scene scene, Quality quality, GLCapabilitiesImmutable glci, boolean traceGL, boolean debugGL) {
    	super(((SWTScaledChartComponentFactory)factory).getComposite(), SWT.NONE);
