...
public class UnitEditingSupport extends EditingSupport {
	...
	protected CellEditor getCellEditor(final Object element) {
		if (element instanceof GridNumericNode) {
			GridNumericNode<? extends Quantity> node = (GridNumericNode<? extends Quantity>)element;
	...
	protected boolean canEdit(Object element) {
		if (!(element instanceof GridNumericNode)) return false;
		GridNumericNode<? extends Quantity> node = (GridNumericNode<? extends Quantity>)element;
	...
	protected Object getValue(Object element) {
		if (!(element instanceof GridNumericNode)) return null;
	...
	protected void setValue(Object element, Object value) {
		if (!(element instanceof GridNumericNode)) return;
