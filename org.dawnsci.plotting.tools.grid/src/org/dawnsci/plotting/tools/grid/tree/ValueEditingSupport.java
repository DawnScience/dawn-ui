...
public class ValueEditingSupport extends EditingSupport {
	...
	protected CellEditor getCellEditor(final Object element) {
		if (element instanceof GridNumericNode) {
			return createNumericEditor((GridNumericNode<?>) element);
		}
	...
	protected CellEditor createNumericEditor(final GridNumericNode<?> element) {
		
		final GridNumericNode<? extends Quantity> node = element;
	 ...
	 * @return
	 */
	private int getDecimalPlaces(GridNumericNode<? extends Quantity> node) {
	...
	private class NumericNodeEditor extends FloatSpinnerCellEditor {
		...
		private GridNumericNode<?> element;
		public NumericNodeEditor(GridNumericNode<?> element, Composite control, int switches) {
	...
	protected Object getValue(Object element) {
		if (element instanceof GridNumericNode) {
			GridNumericNode<? extends Quantity> node = (GridNumericNode<?>)element;
