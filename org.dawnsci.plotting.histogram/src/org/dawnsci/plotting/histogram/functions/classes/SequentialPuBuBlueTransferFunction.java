...
public class SequentialPuBuBlueTransferFunction extends AbstractTransferFunction {

	@Override
	public double getPoint(double value) {
		return HistogramData.getPointFromRGBData(value, HistogramData.SEQUENTIAL_PUBU, RGBChannel.BLUE);
	}
}
