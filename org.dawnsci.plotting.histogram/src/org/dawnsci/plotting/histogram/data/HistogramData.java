...
public class HistogramData {
	...
	public static double getPointFromRGBData(double value, double[][] data, RGBChannel channel) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (columns == 4 && i > 0 && value <= data[i][0]) {
				return interpolatedY(data[i - 1][0], data[i - 1][channel.value], data[i][0],
	 ...
	 * yR1, yG1, yB1}, {x2, yR2, yG2, yB2}...}<br>
	 */
	public static double[][] DIVERGENT_RYG = new double[][] {{0.0, 0.64705884456634521, 0.0, 0.14901961386203766},
		{0.10000000000000001, 0.84313726425170898, 0.18823529779911041, 0.15294118225574493},
		...
		{0.59999999999999998, 0.85098040103912354, 0.93725490570068359, 0.54509806632995605},
		{0.69999999999999996, 0.65098041296005249, 0.85098040103912354, 0.41568627953529358},
		{0.80000000000000004, 0.40000000596046448, 0.74117648601531982, 0.38823530077934265},
		{0.90000000000000002, 0.10196078568696976, 0.59607845544815063, 0.31372550129890442},
		{1.0, 0.0, 0.40784314274787903, 0.21568627655506134}};
	/**
	 * SPECTRAL colour map data from Matplotlib where {{x0, yR0, yG0, yB0}, {x1,
	 * yR1, yG1, yB1}, {x2, yR2, yG2, yB2}...}<br>
	 */
	public static double[][] DIVERGENT_SPECTRAL = new double[][] {{0.0, 0.61960786581039429, 0.0039215688593685627, 0.25882354378700256},
	...
	/**
	 * BLUES colour map data from Matplotlib where {{x0, yR0, yG0, yB0}, {x1,
	 * yR1, yG1, yB1}, {x2, yR2, yG2, yB2}...}<br>
	 */
	public static double[][] SEQUENTIAL_BLUES = new double[][] {{0.0, 0.9686274528503418, 0.9843137264251709, 1.0},
		{0.125, 0.87058824300765991, 0.92156863212585449, 0.9686274528503418},
		{0.25, 0.7764706015586853, 0.85882353782653809, 0.93725490570068359},
		{0.375, 0.61960786581039429, 0.7921568751335144, 0.88235294818878174},
		{0.5, 0.41960784792900085, 0.68235296010971069, 0.83921569585800171},
		{0.625, 0.25882354378700256, 0.57254904508590698, 0.7764706015586853},
		{0.75, 0.12941177189350128, 0.44313725829124451, 0.70980393886566162},
		{0.875, 0.031372550874948502, 0.31764706969261169, 0.61176472902297974},
		{1.0, 0.031372550874948502, 0.18823529779911041, 0.41960784792900085}};

	/**
	 * BLUEGN colour map data from Matplotlib where {{x0, yR0, yG0, yB0}, {x1,
	 * yR1, yG1, yB1}, {x2, yR2, yG2, yB2}...}<br>
	 */
	public static double[][] SEQUENTIAL_BUGN = new double[][] {{0.0, 0.9686274528503418, 0.98823529481887817, 0.99215686321258545},
		{0.125, 0.89803922176361084, 0.96078431606292725, 0.97647058963775635},
		{0.25, 0.80000001192092896, 0.92549020051956177, 0.90196079015731812},
		{0.375, 0.60000002384185791, 0.84705883264541626, 0.78823530673980713},
		{0.5, 0.40000000596046448, 0.7607843279838562, 0.64313727617263794},
		{0.625, 0.25490197539329529, 0.68235296010971069, 0.46274510025978088},
		{0.75, 0.13725490868091583, 0.54509806632995605, 0.27058824896812439},
		{0.875, 0.0, 0.42745098471641541, 0.17254902422428131},
		{1.0, 0.0, 0.26666668057441711, 0.10588235408067703}};
	...
	public static double[][] MAGMA = new double[][] {{0.001462, 0.000466, 0.013866},
	...
	public static double[][] INFERNO = new double[][]{{0.001462, 0.000466, 0.013866},
	...
	public static double[][] PLASMA = new double[][]{{0.050383, 0.029803, 0.527975},
	...
	public static double[][] VIRIDIS = new double[][]{{0.267004, 0.004874, 0.329415},
