...
public class FittedPeaksExportWizard extends Wizard implements IExportWizard {
	...
	public boolean performFinish() {
		...
		if (view == null || view.getCurrentPage()==null || !(view.getCurrentPage() instanceof AbstractFittingTool)) {
		...
		try {
			final String exportPath = ((AbstractFittingTool)view.getCurrentPage()).exportFittedData(ep.getPath());
