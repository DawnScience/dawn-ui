...
import org.dawnsci.plotting.system.dialog.ImageTraceComposite;
import org.dawnsci.plotting.system.dialog.RegionComposite;
        ...
        if ( ((RegionArea)regionGraph.getPlotArea()).hasUserRegions()){
        	...
        	regionCombo.setLayoutData(new GridData(SWT.FILL, 0, true, false));
 	        ...
 	        for(AbstractSelectionRegion region : ((RegionArea)regionGraph.getPlotArea()).getRegions()){
		        ...
		        RegionComposite regionPage = new RegionComposite(regionConfigComposite, SWT.NONE, (XYRegionGraph)xyGraph, region.getRegionType(), false);
