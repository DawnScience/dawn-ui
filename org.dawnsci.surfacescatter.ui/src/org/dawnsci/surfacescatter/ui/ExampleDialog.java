...
//import org.dawnsci.surfacescatter.ui.MultipleOutputCurvesTable;
//import org.dawnsci.surfacescatter.ui.OutputMovie;
...
//import org.dawnsci.surfacescatter.ui.RegionSetterZoomed;
...
////				gms.get(sm.getSelection()).getImageName()
...
//	    		PlotSystemCompositeDataSetter.imageSetter(models.get(sm.getSelection()), 0), 1);
//					
...
//	             			gms.get(sm.getSelection()), customComposite.getPlotSystem(), 
...
//								customComposite2.getPlotSystem1(),
//								customComposite2.getImage());
//						ILineTrace lt2 = VerticalHorizontalSlices.horizontalsliceBackgroundSubtracted(customComposite2.getRegions()[0].getROI().getBounds(),
//								customComposite2.getPlotSystem1(),
//								background);
//						
//						IDataset backSubTop = Maths.subtract(lt1.getYData(), lt2.getYData());
...
//								customComposite2.getImage(),
//								customComposite2.getPlotSystem3());
//						ILineTrace lt4 = VerticalHorizontalSlices.verticalsliceBackgroundSubtracted(customComposite2.getRegions()[1].getROI().getBounds(),
//								customComposite2.getPlotSystem3()
//								,background);
//						
//						IDataset backSubSide = Maths.subtract(lt3.getYData(), lt4.getYData());
...
//	 
//////////////////////////////////////////////////////////////////////////////////////
/////////////////////////Cross Hairs Background slice viewer//////////////////////////////////////
///////////////////Keywords: cross hairs viewer, crosshairs, image examiner/////////////////////////////
//////////////////////////////////////////////////////////////////////////
//	    
...
//		             			dms.get(g), 
//		             			gms.get(g), customComposite.getPlotSystem(), 
//		             			paramField.getTabFolder().getSelectionIndex(), 
//		             			customComposite.getSliderPos(), 0);
//				             	
//		             	customComposite1.getPlotSystem().createPlot2D(j, null, null);
...
//				zoom.open();
//				
//				customComposite1.setFitPowerDropDown(models.get(sm.getSelection()).getFitPower());
//				customComposite1.setMethodologyDropDown(models.get(sm.getSelection()).getMethodology());
...
//					customComposite.getBoxPosition();
//						
//					IDataset output1 = DummyProcessingClass.DummyProcess(sm, j, model,
...
//					IDataset output1 = DummyProcessingClass.DummyProcess(sm, j, model
//							,dm, gm, customComposite.getPlotSystem()
//							, correctionSelection, k-1, trackingMarker);
//							
////					System.out.println("Added to yList:  " + k);
//	
//					Display.getDefault().syncExec(new Runnable() {
