...
public abstract class ScatteringQuantity<E extends Quantity<E>>  {
	protected Quantity<E> value;
	/**
	 ...
	 */
	public ScatteringQuantity(Quantity<E> value) {
		this.value = value;
	}
	 ...
	 */
	public <U extends Quantity<U>, T extends ScatteringQuantity<U>> T to(T scatteringQuantity) {
	 ...
	 * 
	 * @throws ClassCastException If the given Quantity<?> is not compatible with the Quantity used for this ScatteringQuantity.
	 */
