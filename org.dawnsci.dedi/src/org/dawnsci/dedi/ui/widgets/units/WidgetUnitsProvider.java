...
public abstract class WidgetUnitsProvider<T extends Quantity<T>> extends Composite implements IUnitsProvider<T> {
	...
	protected void notifyListeners() {
		for (IUnitsChangeListener listener : listeners)
