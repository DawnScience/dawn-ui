...
public class LabelWithUnits<T extends Quantity<T>> extends WidgetWithUnits<T> implements IAmountChangeListener {
	...
	public void amountChanged() {
		...
		valueLabel.setText(TextUtil.format(currentAmount.getValue().doubleValue()));
		layout();
		getParent().layout();
	}
}
